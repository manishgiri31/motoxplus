    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 border-b border-[var(--border-color)]">
        <Link href="/" className="flex flex-col items-center gap-3 text-center">
          ...
          <div>
            ...
            <div className="text-red-600 text-[9px] uppercase tracking-widest mt-1 font-semibold">Dealer Portal</div>
          </div>
        </Link>
      </div>
      ...
      <div className="p-4 mx-4 my-4 glass border border-[var(--border-color)] rounded-sm">
        ...
        <div className="mt-2 inline-flex items-center gap-1.5">
          ...
          <span className="text-green-500 text-[10px] uppercase tracking-widest font-semibold">Active Dealer</span>
        </div>
      </div>
