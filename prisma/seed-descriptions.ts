/**
 * Adds descriptions to all products that have null/empty descriptions.
...
async function main() {
  console.log("🔍 Fetching products without descriptions...\n");
  ...
  if (products.length === 0) {
    console.log("✅ All products already have descriptions. Nothing to update.");
    return;
  }

  console.log(`Found ${products.length} products missing descriptions.\n`);
